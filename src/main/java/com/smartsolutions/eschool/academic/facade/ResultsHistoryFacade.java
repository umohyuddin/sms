...
public class ResultsHistoryFacade {
    ...
    public List<StudentExamMarksResponseDTO> getMarksByExamSubject(Long examSubjectId) {
        return marksService.getByExamSubject(examSubjectId);
    }
    ...
    // Student Term Result
    public void processTermResults(Long standardId, Long sectionId, Long examTermId) {
        resultService.processResults(standardId, sectionId, examTermId);
    }

    public List<StudentTermResultResponseDTO> getSectionTermResults(Long standardId, Long sectionId, Long examTermId) {
        return resultService.getSectionResults(standardId, sectionId, examTermId);
    }

    public StudentTermResultResponseDTO getStudentTermResult(Long studentId, Long examTermId) {
        return resultService.getStudentResult(studentId, examTermId);
    }

    // Report Card
    public ReportCardResponseDTO generateReportCard(ReportCardRequestDTO dto) {
        return reportCardService.generate(dto);
    }

    public List<ReportCardResponseDTO> getReportCardsByStudent(Long studentId) {
        return reportCardService.getByStudent(studentId);
    }
    ...
    // Grade Scale
    public GradeScaleResponseDTO createGradeScale(GradeScaleRequestDTO dto) {
        return gradeScaleService.create(dto);
    }

    public GradeScaleResponseDTO updateGradeScale(Long id, GradeScaleRequestDTO dto) {
        return gradeScaleService.update(id, dto);
    }

    public GradeScaleResponseDTO getGradeScaleById(Long id) {
        return gradeScaleService.getById(id);
    }

    public List<GradeScaleResponseDTO> getAllActiveGradeScales() {
        return gradeScaleService.getAllActive();
    }

    public List<GradeScaleResponseDTO> searchGradeScales(String keyword) {
        return gradeScaleService.searchByKeyword(keyword);
    }
