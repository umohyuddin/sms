...
public class EnrollmentController {
    ...
    public MultiResourceSuccessResponseObject create(
        ...
        Map<String, Object> resourceAttributes = Map.of("message",nEnrollmentFacade.create(nEnrollmentEntity));
        List<ResourceObject> resourceObject = new ArrayList<>();
        resourceObject.add(new ResourceObject(
    ...
    public MultiResourceSuccessResponseObject update(
        ...
        Map<String, Object> attributes = (Map<String, Object>) resourceMap.get("attributes");
        EnrollmentEntity nEnrollmentEntity = objectMapper.convertValue(attributes, EnrollmentEntity.class);
        Map<String, Object> resourceAttributes = Map.of("message",nEnrollmentFacade.update(nEnrollmentEntity));
        List<ResourceObject> resourceObject = new ArrayList<>();
        resourceObject.add(new ResourceObject(
