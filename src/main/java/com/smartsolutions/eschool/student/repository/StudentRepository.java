...
public interface StudentRepository extends JpaRepository<StudentEntity, Long> {
        ...
        @Query("""
                            ...
                            WHERE s.organizationId = :organizationId AND s.deleted = false
                              ...
                              AND (:academicYearId IS NULL OR s.academicYear.id = :academicYearId)
                        """)
        Long countByFilters(@Param("campusIds") List<Long> campusIds, @Param("academicYearId") Long academicYearId,
                        @Param("organizationId") Long organizationId);
        ...
        @Query("""
                            ...
                            WHERE s.organizationId = :organizationId AND s.isActive = true AND s.deleted = false
                              ...
                              AND (:academicYearId IS NULL OR s.academicYear.id = :academicYearId)
                        """)
        Long countActiveByFilters(@Param("campusIds") List<Long> campusIds,
                        @Param("academicYearId") Long academicYearId, @Param("organizationId") Long organizationId);
        ...
        @Query("""
                            ...
                            WHERE s.organizationId = :organizationId AND s.deleted = false
                              ...
                              AND (:campusIds IS NULL OR s.campus.id IN :campusIds)
                        """)
        Long countNewAdmissions(@Param("fromDate") LocalDate fromDate, @Param("toDate") LocalDate toDate,
                        @Param("campusIds") List<Long> campusIds, @Param("organizationId") Long organizationId);
        ...
        @Query("""
                            ...
                            GROUP BY s.gender
                        """)
        List<Object[]> countByGenderDistribution(@Param("campusIds") List<Long> campusIds,
                        @Param("organizationId") Long organizationId);
