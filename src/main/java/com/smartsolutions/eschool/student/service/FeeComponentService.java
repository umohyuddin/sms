...
public class FeeComponentService {
        ...
        public List<FeeComponentResponseDTO> getAll() throws ApiException {
                ...
                List<FeeComponentEntity> result = feeComponentRepository.findByOrganization(organizationId);

                List<FeeComponentResponseDTO> response = FeeComponentMapper.toDtoList(result);
        ...
        public FeeComponentResponseDTO getById(Long id) {
                ...
                FeeComponentEntity entity = feeComponentRepository.findByIdWithDetails(id)
                                .orElseThrow(() -> new ApiException(
                                                FeeComponentErrors.FEE_COMPONENT_NOT_FOUND,
                                                HttpStatus.NOT_FOUND));

                FeeComponentResponseDTO response = FeeComponentMapper.toDto(entity);
        ...
        public List<FeeComponentResponseDTO> getByCatalog(Long catalogId) {
                ...
                List<FeeComponentEntity> result = feeComponentRepository.findByCatalogIdWithDetails(catalogId);

                List<FeeComponentResponseDTO> response = FeeComponentMapper.toDtoList(result);

                log.info("[Service:FeeComponentService] getByCatalog() succeeded - Found {} components",
                                response.size());
        ...
        public List<FeeComponentResponseDTO> search(Long catalogId, String keyword) {
                ...
                log.info("[Service:FeeComponentService] search() called - catalogId: {}, keyword: {}", catalogId,
                                keyword);

                List<FeeComponentEntity> result = feeComponentRepository.searchComponents(catalogId, keyword);
        ...
        public FeeComponentResponseDTO create(FeeCatalogComponentRequestDTO requestDTO) {
                ...
                FeeCatalogEntity catalog = feeCatalogRepository.findById(requestDTO.getFeeCatalogId())
                                .orElseThrow(() -> new ApiException(
                                                FeeComponentErrors.FEE_CATALOG_NOT_FOUND,
                                                HttpStatus.NOT_FOUND));

                Optional<FeeComponentEntity> duplicate = feeComponentRepository.findByComponentCodeAndCatalogId(
                ...
                FeeComponentEntity entity = FeeComponentMapper.toEntity(requestDTO);
        ...
        public FeeComponentResponseDTO update(Long id, FeeCatalogComponentRequestDTO requestDTO) {
                ...
                FeeComponentEntity existing = feeComponentRepository.findById(id)
                                .orElseThrow(() -> new ApiException(
                                                FeeComponentErrors.FEE_COMPONENT_NOT_FOUND,
                                                HttpStatus.NOT_FOUND));
                ...
                FeeComponentEntity updated = feeComponentRepository.save(existing);
