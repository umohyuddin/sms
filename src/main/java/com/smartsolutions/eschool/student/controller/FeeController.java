...
public class FeeController {
    ...
    public SingleResourceSuccessResponseObject create(
        ...
        Map<String, Object> resourceAttributes = objectMapper.convertValue(feeFacade.create(nFeeEntity), Map.class);
        ResourceObject resourceObject = new ResourceObject(
    ...
    public SingleResourceSuccessResponseObject update(
        ...
        Map<String, Object> attributes = (Map<String, Object>) resourceMap.get("attributes");
        FeeEntity nFeeEntity = objectMapper.convertValue(attributes, FeeEntity.class);
        Map<String, Object> resourceAttributes = objectMapper.convertValue(feeFacade.update(nFeeEntity), Map.class);
        ResourceObject resourceObject = new ResourceObject(
                String.valueOf(nFeeEntity.getFeeId()),
                "Fee",
                resourceAttributes
    ...
    public SingleResourceSuccessResponseObject delete(
        ...
        Map<String, Object> resourceAttributes = objectMapper.convertValue(feeFacade.delete(id), Map.class);
        ResourceObject resourceObject = new ResourceObject(
                String.valueOf(id),
                "Fee",
                resourceAttributes
